...
public class ItemAuctionInstance
{
		...
		public void runImpl() throws Exception
		{
			...
			switch(state)
			{
				case CREATED:
				{
					...
					{
						Announcements.getInstance().announceToAll(new CustomMessage("itemauction.announce." + _auction.getInstanceId()));
					}
					checkAndSetCurrentAndNextAuction();
					break;
				}
	...
	{
		auction.broadcastToAllBidders(new SystemMessage(SystemMsg.S1S_AUCTION_HAS_ENDED).addNumber(auction.getAuctionId()));
