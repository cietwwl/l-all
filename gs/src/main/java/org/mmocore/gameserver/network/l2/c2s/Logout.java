...
public class Logout extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2p.gameserver.clientpackets.Logout.OutOfControl"));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("l2p.gameserver.clientpackets.Logout.Olympiad"));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("l2p.gameserver.clientpackets.Logout.Observer"));
			activeChar.sendActionFailed();
			return;
		}
