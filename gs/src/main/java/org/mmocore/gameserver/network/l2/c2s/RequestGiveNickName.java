...
import org.mmocore.gameserver.network.l2.s2c.NickNameChanged;
...
public class RequestGiveNickName extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(member != null)
		{
			...
			activeChar.sendMessage(new CustomMessage("l2p.gameserver.clientpackets.RequestGiveNickName.NotInClan"));
