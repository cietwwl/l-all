...
import org.mmocore.gameserver.network.l2.s2c.JoinPledge;
import org.mmocore.gameserver.network.l2.s2c.PledgeShowInfoUpdate;
import org.mmocore.gameserver.network.l2.s2c.PledgeShowMemberListAdd;
...
public class RequestAnswerJoinPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(_response == 0 || player.isInOlympiadMode() || player.getTeam() != TeamType.NONE) // FIXME: DS: какой-то другой способ
		{
			request.cancel();
