...
import static org.mmocore.gameserver.network.l2.s2c.FlyToLocation.FlyType.NONE;
...
public class ValidatePosition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (boat != null)
		{
			...
			{ // DS: перемещение на корабле не реализовано, сразу задается конечная точка, поэтому рассылаем валидейт только при очень грубых ошибках
