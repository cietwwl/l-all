...
import org.mmocore.gameserver.network.l2.c2s.RequestExDeleteReceivedPost;
import org.mmocore.gameserver.network.l2.c2s.RequestExPostItemList;
import org.mmocore.gameserver.network.l2.c2s.RequestExRequestReceivedPost;
import org.mmocore.gameserver.network.l2.c2s.RequestExRequestReceivedPostList;
...
public class ExShowReceivedPostList extends L2GameServerPacket
{
	...
	public ExShowReceivedPostList(Player cha)
	{
		...
		CollectionUtils.shellSort(mails);
	}
