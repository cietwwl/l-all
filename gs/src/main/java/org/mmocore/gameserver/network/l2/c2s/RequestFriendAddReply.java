...
public class RequestFriendAddReply extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		requestor.sendPacket(SystemMsg.THAT_PERSON_HAS_BEEN_SUCCESSFULLY_ADDED_TO_YOUR_FRIEND_LIST, new SystemMessage(SystemMsg.S1_HAS_BEEN_ADDED_TO_YOUR_FRIENDS_LIST).addString(activeChar.getName()), new L2Friend(activeChar, true));
