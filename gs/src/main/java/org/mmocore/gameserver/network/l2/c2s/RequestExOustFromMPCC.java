...
public class RequestExOustFromMPCC extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		target.getParty().getCommandChannel().getChannelLeader().sendPacket(new SystemMessage(SystemMsg.C1S_PARTY_HAS_BEEN_DISMISSED_FROM_THE_COMMAND_CHANNEL).addString(target.getName()));
