...
public class RequestOustAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(clan != null)
		{
			...
			activeChar.sendMessage(new CustomMessage("l2p.gameserver.clientpackets.RequestOustAlly.ClanDismissed").addString(clan.getName()).addString(alliance.getAllyName()));
		}
	}
}