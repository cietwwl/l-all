...
import org.mmocore.gameserver.network.l2.s2c.ExReplyReceivedPost;
				...
				synchronized (attachments)
				{
					...
					if(price > 0)
					{
						...
						if(sender != null)
						{
							...
							Log.LogItem(activeChar, ItemLog.PostPrice, ItemTemplate.ITEM_ID_ADENA, price);
						}
						else
						{
							...
							Log.LogItem(activeChar, ItemLog.PostPrice, item);
