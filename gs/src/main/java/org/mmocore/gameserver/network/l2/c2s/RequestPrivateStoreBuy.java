		...
		finally
		{
			try
			{
				...
				for(TradeItem bi : buyList)
				{
					...
					Log.LogItem(seller, ItemLog.PrivateStoreSell, item, item.getCount(), bi.getOwnersPrice());
					Log.LogItem(buyer, ItemLog.PrivateStoreBuy, item, item.getCount(), bi.getOwnersPrice());
