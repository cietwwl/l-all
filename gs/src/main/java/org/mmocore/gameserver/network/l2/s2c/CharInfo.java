...
public class CharInfo extends L2GameServerPacket
{
	...
	private boolean _isPartyRoomLeader, _isFlying, _activeRelation;
	...
	public CharInfo(Creature cha)
	{
		...
		_inv = new int[PcInventory.PAPERDOLL_MAX][3]; // itemId augmentationId1 augmentationId2
		...
		for(int PAPERDOLL_ID : PAPERDOLL_ORDER)
		{
			...
			_inv[PAPERDOLL_ID][1] = augmentations[0];
			_inv[PAPERDOLL_ID][2] = augmentations[1];
		}
