...
public class PetInfo extends L2GameServerPacket
{
	...
	public PetInfo(Servitor servitor)
	{
		...
		PAtkSpd = servitor.getPAtkSpd(true);
		_runSpd = servitor.getRunSpeed();
		_walkSpd = servitor.getWalkSpeed();
		col_redius = servitor.getColRadius();
		col_height = servitor.getColHeight();
		...
		_abnormalEffect = servitor.getAbnormalEffect(AbnormalEffectType.FIRST);
		_abnormalEffect2 = servitor.getAbnormalEffect(AbnormalEffectType.SECOND);
