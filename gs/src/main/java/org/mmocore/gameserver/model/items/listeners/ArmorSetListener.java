...
public final class ArmorSetListener implements OnEquipListener
{
	...
	public void onUnequip(int slot, ItemInstance item, Playable actor)
	{
		...
		List<SkillEntry> removeSkillId1 = new ArrayList<SkillEntry>(1); // set skill
		List<SkillEntry> removeSkillId2 = new ArrayList<SkillEntry>(1); // shield skill
		List<SkillEntry> removeSkillId3 = new ArrayList<SkillEntry>(1); // enchant +6 skill
