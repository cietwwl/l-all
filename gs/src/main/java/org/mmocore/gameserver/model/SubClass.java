...
public class SubClass
{
	...
	private long _exp = Experience.LEVEL[40], minExp = Experience.LEVEL[40], maxExp = Experience.LEVEL[Experience.LEVEL.length - 1];
	private int _sp = 0;
	...
	{
		_isBase = base;
		minExp = Experience.LEVEL[_isBase ? 1 : 40];
