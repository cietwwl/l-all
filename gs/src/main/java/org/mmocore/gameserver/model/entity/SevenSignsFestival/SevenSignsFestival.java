	...
	private void addReputationPointsForPartyMemberClan(String playerId)
	{
		...
		if(player != null)
		{
			if(player.getClan() != null)
			{
				...
				SystemMessage sm = new SystemMessage(SystemMsg.CLAN_MEMBER_C1_WAS_AN_ACTIVE_MEMBER_OF_THE_HIGHESTRANKED_PARTY_IN_THE_FESTIVAL_OF_DARKNESS_S2_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLANS_REPUTATION_SCORE);
				sm.addName(player);
				sm.addNumber(100);
