...
public final class ArmorSet
{
	...
	private final List<SkillEntry> _skills = new ArrayList<SkillEntry>(1);
	private final List<SkillEntry> _shieldSkills = new ArrayList<SkillEntry>(1);
	private final List<SkillEntry> _enchant6skills = new ArrayList<SkillEntry>(1);
		...
		if(skills != null)
			for(String skill : skills)
			{
				...
				if(st.hasMoreTokens())
				{
					...
					_skills.add(SkillTable.getInstance().getSkillEntry(skillId, skillLvl));
				}
				//Adding constant 'set' skill
				_skills.add(SkillTable.getInstance().getSkillEntry(3006, 1));
			}
		...
		if(shield_skills != null)
			for(String skill : shield_skills)
			{
				...
				if(st.hasMoreTokens())
				{
					int skillId = Integer.parseInt(st.nextToken());
					int skillLvl = Integer.parseInt(st.nextToken());
					_shieldSkills.add(SkillTable.getInstance().getSkillEntry(skillId, skillLvl));
				}
			}
		...
		if(enchant6skills != null)
			for(String skill : enchant6skills)
			{
				...
				if(st.hasMoreTokens())
				{
					int skillId = Integer.parseInt(st.nextToken());
					int skillLvl = Integer.parseInt(st.nextToken());
					_enchant6skills.add(SkillTable.getInstance().getSkillEntry(skillId, skillLvl));
				}
			}
	}
