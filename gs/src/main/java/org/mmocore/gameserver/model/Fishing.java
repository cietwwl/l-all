...
import org.mmocore.gameserver.network.l2.s2c.ExFishingEnd;
import org.mmocore.gameserver.network.l2.s2c.ExFishingHpRegen;
import org.mmocore.gameserver.network.l2.s2c.ExFishingStart;
import org.mmocore.gameserver.network.l2.s2c.ExFishingStartCombat;
	...
	private void doDie(boolean win)
	{
		...
		if(win)
			...
			else
			{
				...
				ItemFunctions.addItem(_fisher, _fish.getId(), 1);
