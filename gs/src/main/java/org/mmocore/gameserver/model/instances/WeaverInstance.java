...
public class WeaverInstance extends MerchantInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if(actualCommand.equalsIgnoreCase("unseal"))
		{
			...
			if(!ItemFunctions.deleteItem(player, id, 1))
			{
