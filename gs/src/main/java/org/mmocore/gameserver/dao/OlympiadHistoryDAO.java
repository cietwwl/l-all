...
public class OlympiadHistoryDAO
{
	...
	public Map<Boolean, List<OlympiadHistoryEntry>> select()
	{
		Map<Boolean, List<OlympiadHistoryEntry>> map = null;
		Connection con = null;
		...
		try
		{
			...
			map = new HashMap<Boolean, List<OlympiadHistoryEntry>>(2);
			map.put(Boolean.TRUE, new ArrayList<OlympiadHistoryEntry>());
			map.put(Boolean.FALSE, new ArrayList<OlympiadHistoryEntry>());
			...
			while(rset.next())
			{
				...
				OlympiadHistoryEntry history = new OlympiadHistoryEntry(objectId1, objectId2, classId1, classId2, name1, name2, rset.getLong("game_start_time"), rset.getInt("game_time"), rset.getInt("game_status"), rset.getInt("game_type"));
	...
	public void insert(OlympiadHistoryEntry history)
	{
		Connection con = null;
