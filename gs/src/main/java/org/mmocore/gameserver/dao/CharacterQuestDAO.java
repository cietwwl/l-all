...
public class CharacterQuestDAO
{
	...
	public void delete(int objectId, int questId)
	{
		Connection con = null;
		PreparedStatement statement = null;
		try
	...
	public void delete(int objectId, int questId, String var)
	{
		Connection con = null;
		PreparedStatement statement = null;
		try
	...
	// Quest : 503
	public void Q503_setLeaderVar(int questId, int leaderId, String var, String value)
	{
		Connection con = null;
		PreparedStatement offline = null;
		try
