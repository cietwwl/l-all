...
import org.mmocore.gameserver.dao.ClanLeaderRequestDAO;
...
public class ClanTable
{
	...
	public void startClanWar(Clan clan1, Clan clan2)
	{
		...
		clan1.broadcastToOnlineMembers(new SystemMessage(SystemMsg.A_CLAN_WAR_HAS_BEEN_DECLARED_AGAINST_THE_CLAN_S1__IF_YOU_ARE_KILLED_DURING_THE_CLAN_WAR_BY_MEMBERS_OF_THE_OPPOSING_CLAN_YOU_WILL_ONLY_LOSE_A_QUARTER_OF_THE_NORMAL_EXPERIENCE_FROM_DEATH).addString(clan2.getName()));
