	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_accept_petition:
				...
				{
					activeChar.sendPacket(new SystemMessage(SystemMsg.YOU_MAY_ONLY_SUBMIT_ONE_PETITION_ACTIVE_AT_A_TIME));
					return true;
				}
				...
				if(!PetitionManager.getInstance().acceptPetition(activeChar, petitionId))
					activeChar.sendPacket(new SystemMessage(SystemMsg.NOT_UNDER_PETITION_CONSULTATION));
