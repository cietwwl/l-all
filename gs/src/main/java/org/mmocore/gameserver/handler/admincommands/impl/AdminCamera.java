...
import org.mmocore.gameserver.model.base.SpecialEffectState;
import org.mmocore.gameserver.network.l2.s2c.CameraMode;
import org.mmocore.gameserver.network.l2.s2c.SpecialCamera;
		...
		switch(command)
		{
			case admin_freelook:
			{
				...
				else
				{
					...
					activeChar.setInvul(SpecialEffectState.FALSE);
