...
import org.mmocore.gameserver.network.l2.s2c.MultiSellList;
...
public class MultiSellHolder extends AbstractHolder
{
	...
	public void addCustomMultiSellListContainer(int id, MultiSellListContainer list)
	{
		list.setListId(id);
		_entries.put(id, list);
	}
	...
	public void SeparateAndSend(int listId, Player player, int npcObjectId, double taxRate)
	{
		...
		if(list == null)
		{
			_log.error("Multisell Id : " + listId + " not found!");
			return;
		}
