...
public class InstantZoneParser extends AbstractDirParser<InstantZoneHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			String n = element.attributeValue("displayId");
			displayId = n != null ? Integer.parseInt(n) : instanceId;

			n = element.attributeValue("timelimit");
			if(n != null)
			...
			InstantZone instancedZone = new InstantZone(instanceId, displayId, name, resetReuse, sharedReuseGroup, timelimit, dispelBuffs, minLevel, maxLevel, minParty, maxParty, timer, onPartyDismiss, teleportLocs, ret, mapx, mapy, doors, zones, spawns2,  spawns, collapseIfEmpty, maxChannels, removedItemId, removedItemCount, removedItemNecessity, giveItemId, givedItemCount, requiredQuestId, setReuseUponEntry, params);
