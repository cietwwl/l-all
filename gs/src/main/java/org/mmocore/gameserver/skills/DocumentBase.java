...
import org.mmocore.gameserver.stats.conditions.ConditionConfigBoolean;
import org.mmocore.gameserver.stats.conditions.ConditionGameTime;
import org.mmocore.gameserver.stats.conditions.ConditionGameTime.CheckGameTime;
import org.mmocore.gameserver.stats.conditions.ConditionHasSkill;
import org.mmocore.gameserver.stats.conditions.ConditionLogicAnd;
import org.mmocore.gameserver.stats.conditions.ConditionLogicNot;
import org.mmocore.gameserver.stats.conditions.ConditionLogicOr;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerAgathion;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerBoat;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerChargesMax;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerChargesMin;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerClassId;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerCubic;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerDominionWar;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerEncumbered;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerHasBuff;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerHasBuffId;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerHasSummon;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerInstanceZone;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerIsHero;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerIsMageClass;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerMaxLevel;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerMaxPK;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerMinLevel;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerMinMaxDamage;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerOlympiad;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerPercentCp;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerPercentHp;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerPercentMp;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerRace;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerRiding;
...
import org.mmocore.gameserver.stats.conditions.ConditionPlayerSummonSiegeGolem;
import org.mmocore.gameserver.stats.conditions.ConditionPlayerTransformation;
import org.mmocore.gameserver.stats.conditions.ConditionSlotItemId;
import org.mmocore.gameserver.stats.conditions.ConditionTargetAggro;
import org.mmocore.gameserver.stats.conditions.ConditionTargetCastleDoor;
import org.mmocore.gameserver.stats.conditions.ConditionTargetClan;
import org.mmocore.gameserver.stats.conditions.ConditionTargetDirection;
import org.mmocore.gameserver.stats.conditions.ConditionTargetForbiddenClassId;
import org.mmocore.gameserver.stats.conditions.ConditionTargetHasBuff;
import org.mmocore.gameserver.stats.conditions.ConditionTargetHasBuffId;
import org.mmocore.gameserver.stats.conditions.ConditionTargetHasForbiddenSkill;
import org.mmocore.gameserver.stats.conditions.ConditionTargetMob;
import org.mmocore.gameserver.stats.conditions.ConditionTargetMobId;
import org.mmocore.gameserver.stats.conditions.ConditionTargetNpcClass;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPercentCp;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPercentHp;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPercentMp;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPlayable;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPlayer;
import org.mmocore.gameserver.stats.conditions.ConditionTargetPlayerRace;
import org.mmocore.gameserver.stats.conditions.ConditionTargetRace;
import org.mmocore.gameserver.stats.conditions.ConditionTargetSummon;
import org.mmocore.gameserver.stats.conditions.ConditionUsingArmor;
import org.mmocore.gameserver.stats.conditions.ConditionUsingBlowSkill;
import org.mmocore.gameserver.stats.conditions.ConditionUsingItemType;
import org.mmocore.gameserver.stats.conditions.ConditionUsingSkill;
import org.mmocore.gameserver.stats.conditions.ConditionZoneType;
...
abstract class DocumentBase
{
	...
	protected void attachEffect(Node n, Object template)
	{
		...
		{
			final int count = parseNumber(attrs.getNamedItem("count").getNodeValue()).intValue();
			if (count == 0) // Не добавляем эффект если указан count="0"
				return;
			set.set("count", count);
		}
	...
	protected Condition parsePlayerCondition(Node n)
	{
		...
		for(int i = 0; i < attrs.getLength(); i++)
		{
			...
			{
				cond = joinAnd(cond, new ConditionPlayerBoat(Boolean.valueOf(a.getNodeValue())));
			}
	...
	protected Condition parseConfigCondition(Node n)
	{
		...
		final Node val = attrs.getNamedItem("val");
		if (name != null && val != null)
		{
			...
			if (field != null)
			{
				if (field.getType() == boolean.class)
					cond = joinAnd(cond, new ConditionConfigBoolean(field, Boolean.valueOf(val.getNodeValue())));				
			}
		}
		if(cond == null)
			_log.error("Unrecognized <config> condition in " + file);
		return cond;
	}
