...
public class EffectsComparator implements Comparator<Effect>
{
	...
	{
		boolean toggle1 = e1.getSkill().getTemplate().isToggle();
		boolean toggle2 = e2.getSkill().getTemplate().isToggle();
		...
		boolean music1 = e1.getSkill().getTemplate().isMusic();
		boolean music2 = e2.getSkill().getTemplate().isMusic();
		...
		boolean trigger1 = e1.getSkill().getTemplate().isTrigger();
		boolean trigger2 = e2.getSkill().getTemplate().isTrigger();
